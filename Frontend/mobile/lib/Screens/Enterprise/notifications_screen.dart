...
class EnterpriseNotificationsScreen extends StatefulWidget {
  ...
  @override
  State<EnterpriseNotificationsScreen> createState() => _EnterpriseNotificationsScreenState();
}

class _EnterpriseNotificationsScreenState extends State<EnterpriseNotificationsScreen> {
  ...
  Future<void> _onNotificationTap(app.Notification notification) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        // For enterprises, we might want to navigate to applicants or PFE details
        if (notification.pfeListingId != null) {
          // Navigate back to overview - enterprise can see their PFEs there
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'You\'ll receive notifications about new applications',
              style: TextStyle(
                fontSize: 14,
